...
function gallery_scripts() {
	...
	wp_register_script( 'shortcode_js', plugins_url('js/gallery.shortcode.js', __FILE__), array('galleria_theme'),'',true);
...
function gallery_shortcode_plus($attr) {
	...
	extract(shortcode_atts(array(
		'type'       => 'lightbox', // lightbox, slider, core
		'order'      => 'ASC',
